...
const sidebarLinks = [
  ...
  { path: 'my-bids', label: 'My Bids', icon: FaGavel },
...
export default function BuyerDashboardLayout() {
  ...
  return (
    <div className="min-h-screen ">
      {/* Sidebar */}
      <aside className={`fixed inset-y-0 left-0 z-50 w-64 transform bg-[#285380] shadow-lg transition-transform duration-200 ease-in-out ${
            ...
            <Link
              ...
              className={`flex items-center px-4 py-3 mb-2 rounded-lg transition-colors ${
                location.pathname === path
                  ...
                  : 'text-white hover:bg-gray-50 hover:text-[#285380]'
              }`}
            >
              <Icon className="mr-3" />
              {label}
      ...
      <div className={`transition-all duration-200 ${isSidebarOpen ? 'lg:ml-64' : ''}`}>
        <header className="h-16 bg-[#285380] shadow-sm flex items-center px-4">
          <button
